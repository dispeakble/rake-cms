...
export default function Hero() {
  ...
  // ─── Carousel State ───
  const slides = [{"src":"/media/marioviajes/c-img-1.jpg","caption":"Crea tu tipo de vacaciones"},{"src":"/media/marioviajes/c-img-2.jpg","caption":"Crea tu tipo de vacaciones"},{"src":"/media/marioviajes/c-img-3.jpg","caption":"Contact us today"}];
