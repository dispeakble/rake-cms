...
const SERVICES = [{"title":"Quality Service","description":"We're committed to delivering the highest standard of service to every customer, every time."},{"title":"Customer Support","description":"Have a question? Our friendly team is always ready to help with prompt and courteous support."},{"title":"Custom Solutions","description":"Every customer is unique. We work with you to find the solution that best fits your specific needs."}];
